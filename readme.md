...
Каталог `course/` — самостоятельный пошаговый курс на русском языке по идеям книги (не конспект и не перевод): собственные формулировки, собственный сквозной пример «медиатека» и запускаемый код в `course/code/`. Примеры требуют PHP 8.4.
